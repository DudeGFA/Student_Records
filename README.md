...
Script can convert your containers from item 5 under Script Capabilities above into a dataframe identical to the table below and save to an excel or [csv](https://github.com/DudeGFA/Student_Records/blob/main/sample_data.csv) file :
